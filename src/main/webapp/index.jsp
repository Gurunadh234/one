...
<body>
	...
	<h2 style="color: blue; font-size: 40px;" align="center">WE INTEGRATED NEXUS WITH JENKINS</h2>
	<h2 style="color: green; font-size: 40px;" align="center">THIS IS NEXUS TOPIC</h2>
